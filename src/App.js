...
function App() {
  ...
  useEffect(() => {
    socket.on('gameStateUpdate', (state) => {
        ...
        else if (!isRef) setJoined(false); // Handle forced clear
        ...
        <div style={{ padding: '20px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', background: '#111', padding: '15px', borderRadius: '10px', borderBottom: '2px solid gold', alignItems: 'center' }}>
            <div>
                ...
                {/* COMMAND 1: User sees their assigned team immediately */}
            ...
            <div style={{ marginTop: '20px' }}>
              ...
              <div style={{ display: 'flex', gap: '20px' }}>
                ...
                <div style={{ flex: 1.5 }}>
                    ...
                    <div style={{fontSize: '1.1rem', color: 'gold'}}>{calculatePoints(gameState.team1Picks)} pts</div>
                    ...
                    <div style={{fontSize: '1.1rem', color: 'gold'}}>{calculatePoints(gameState.team2Picks)} pts</div>
